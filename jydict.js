...
(function(){
  var cheerio, http, util, argparse, readline, lame, speaker, clc, host_url, refer_url, path_template, parser, parse_cmdline, queryWords, interactiveMode, main;
  ...
  parse_cmdline = function(){
    ...
    root = new argparse.ArgumentParser({
      description: "query vocabulary or phrase from yahoo dictionary,left argument will enter the interactive mode"
    });
    root.addArgument(['words'], {
