...
(function(){
  var doc, fs, path, https, util, readline, cheerio, lame, speaker, docopt, clc, host_url, refer_url, path_template, parser, queryWords, interactiveMode, main;
  ...
  parser = function(html){
    ...
    if (audiolink && audiolink.length > 0) {
      https.get(audiolink, function(res){
  ...
  queryWords = function(words, notify){
    ...
    httpget = https.get(options, function(res){
